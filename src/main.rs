...
fn main() {
    ...
    app.add_plugins(DefaultPlugins)
        ...
        .insert_resource(resources::SaltSteamSettings::NORMAL)
        ...
        .add_startup_system(resources::load_table_arrows)
        ...
        .add_system(sugar::spawn_steam_animations)
        .add_system(sugar::play_death_animations)
        .add_system(sugar::despawn_steam_animations)
