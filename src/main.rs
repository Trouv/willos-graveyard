    ...
    app.insert_resource(ImageSettings::default_nearest())
        ...
        .add_system_set(
            ConditionSet::new()
                ...
                .with_system(goal_ghost::spawn_goal_ghosts)
                .into(),
        )
        .add_system(
        ...
        .add_system(animation::kill_one_shot_sprites.run_not_in_state(GameState::AssetLoading))
        .add_system(goal_ghost::goal_ghost_animation.run_not_in_state(GameState::AssetLoading))
        .add_system(goal_ghost::punctuation.run_not_in_state(GameState::AssetLoading))
        .add_system(goal_ghost::goal_ghost_event_sugar.run_not_in_state(GameState::AssetLoading))
